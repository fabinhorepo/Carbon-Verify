...
300 projetos: 150 Verra (VCS) + 150 Gold Standard (GS).
Distribuição de qualidade:
  - 50% (150) projetos bons (score > 60)
  - 35% (105) projetos medianos / atenção (score 40-60)
  - 15% (45) projetos ruins / rejeição (score < 40)
"""
...
COUNTRIES = [
    ...
    ("Costa Rica", "San José", 9.9, -84.1), ("Panama", "Darién", 8.0, -77.7),
    ("Ecuador", "Napo", -0.9, -77.8), ("Bolivia", "La Paz", -16.5, -68.1),
    ("Chile", "Araucanía", -38.7, -72.6), ("Argentina", "Misiones", -27.4, -55.9),
    ("Paraguay", "Alto Paraná", -25.3, -54.6),
    ("Laos", "Luang Prabang", 19.9, 102.1), ("Sri Lanka", "Central", 7.3, 80.6),
    ("Pakistan", "Sindh", 25.4, 68.4), ("Nigeria", "Cross River", 5.9, 8.3),
    ("Cameroon", "South", 2.9, 11.2), ("Gabon", "Ogooué-Maritime", -1.0, 9.3),
]
...
# 150 Verra: 75 good + 53 medium + 22 bad
# 150 Gold Standard: 75 good + 52 medium + 23 bad
...
_GOOD_NAMES_VERRA = [
    ...
    ("Costa Rica Osa Peninsula REDD+", "REDD+"), ("Panama Darién Gap Conservation", "REDD+"),
    ("Ecuador Napo Wildlife Center", "REDD+"), ("Bolivia Noel Kempff Mercado", "REDD+"),
    ("Chile Araucanía Reforestation", "ARR"), ("Argentina Misiones Atlantic Forest", "REDD+"),
    ("Paraguay Chaco Conservation", "REDD+"), ("Laos Luang Prabang Forest", "REDD+"),
    ("Sri Lanka Central Highlands", "ARR"), ("Pakistan Sindh Mangroves", "Blue Carbon"),
    ("Nigeria Cross River REDD+", "REDD+"), ("Cameroon Southern Forest", "REDD+"),
    ("Gabon Ogooué Maritime Conservation", "REDD+"), ("India UP Solar Micro-Grid", "Renewable Energy"),
    ("Maharashtra Wind Energy Project", "Renewable Energy"),
]
...
_MEDIUM_NAMES_VERRA = [
    ...
    ("Costa Rica Guanacaste Dry Forest", "REDD+"), ("Panama Canal Watershed Pilot", "ARR"),
    ("Ecuador Cloud Forest Buffer", "REDD+"), ("Bolivia Beni Savanna Pilot", "ARR"),
    ("Chile Valdivian Temperate Forest", "REDD+"), ("Argentina Yungas Pilot", "REDD+"),
    ("Paraguay Atlantic Forest Buffer", "REDD+"), ("Laos Nam Et-Phou Louey", "REDD+"),
    ("Sri Lanka Knuckles Range Pilot", "ARR"), ("Pakistan Thar Desert Solar", "Renewable Energy"),
    ("Nigeria Oban Hills Buffer", "REDD+"), ("Cameroon Dja Reserve Buffer", "REDD+"),
    ("Gabon Lopé National Park Buffer", "REDD+"), ("India Odisha Mangrove Pilot V", "Blue Carbon"),
    ("Rwanda Nyungwe Buffer Zone V", "REDD+"), ("Uganda Bwindi Buffer V", "REDD+"),
    ("Zambia Lower Zambezi Pilot V", "REDD+"), ("Malawi Nyika Plateau Pilot V", "ARR"),
    ("Senegal Casamance Pilot V", "Blue Carbon"), ("Honduras La Mosquitia Pilot V", "REDD+"),
    ("Nicaragua Indio Maíz Buffer V", "REDD+"), ("Tanzania Udzungwa Pilot V", "ARR"),
    ("Ghana Atewa Range Pilot V", "REDD+"),
]
...
_BAD_NAMES_VERRA = [
    ...
    ("Phantom Reforestation Ventures", "ARR"), ("Dubious Methane Capture LLC", "Methane Avoidance"),
    ("Shadow Biochar International", "Biochar"), ("Ghost Solar Credits Corp", "Renewable Energy"),
    ("Fake Wind Farm Holdings", "Renewable Energy"), ("Fraudulent Cookstove Inc", "Cookstove"),
    ("Paper Forest Verra Holdings", "REDD+"), ("Hollow Mangrove Credits V", "Blue Carbon"),
    ("Phantom REDD+ Ventures V", "REDD+"), ("Dubious ARR Solutions V", "ARR"),
    ("Shadow Blue Carbon V Corp", "Blue Carbon"), ("Ghost Energy Credits V", "Renewable Energy"),
]
...
_GOOD_NAMES_GS = [
    ...
    ("Costa Rica Braulio Carrillo GS", "REDD+"), ("Panama Chagres Watershed GS", "ARR"),
    ("Ecuador Yasuni Buffer GS", "REDD+"), ("Bolivia Madidi Conservation GS", "REDD+"),
    ("Chile Patagonia Reforestation GS", "ARR"), ("Argentina Gran Chaco GS", "REDD+"),
    ("Paraguay Pantanal GS", "Blue Carbon"), ("Laos Plain of Jars Restoration GS", "ARR"),
    ("Sri Lanka Sinharaja Forest GS", "REDD+"), ("Pakistan Indus Delta Mangrove GS", "Blue Carbon"),
    ("Nigeria Gashaka Gumti GS", "REDD+"), ("Cameroon Korup Forest GS", "REDD+"),
    ("Gabon Ivindo Forest GS", "REDD+"), ("Mexico Sierra Gorda GS", "REDD+"),
    ("Guatemala Sierra de las Minas GS", "ARR"),
]
...
_MEDIUM_NAMES_GS = [
    ...
    ("Costa Rica Tortuguero Buffer GS", "REDD+"), ("Panama San Lorenzo Pilot GS", "ARR"),
    ("Ecuador Cotacachi Cayapas GS", "REDD+"), ("Bolivia Amboró Buffer GS", "REDD+"),
    ("Chile Chiloé Island Pilot GS", "ARR"), ("Argentina Iberá Wetlands GS", "Blue Carbon"),
    ("Paraguay Defensores del Chaco GS", "REDD+"), ("Laos Bolaven Plateau GS", "ARR"),
    ("Sri Lanka Horton Plains Buffer GS", "ARR"), ("Pakistan Margalla Hills GS", "ARR"),
    ("Nigeria Okomu Buffer GS", "REDD+"), ("Cameroon Campo Ma'an GS", "REDD+"),
    ("Gabon Moukalaba-Doudou GS", "REDD+"), ("Mexico Calakmul Buffer GS", "REDD+"),
    ("Guatemala Tikal Buffer GS", "ARR"), ("Senegal Niokolo-Koba GS", "REDD+"),
    ("Mali Boucle du Baoulé GS", "ARR"), ("Burkina Faso W National Park GS", "REDD+"),
    ("Tanzania Mahale Mountains GS", "REDD+"), ("Mozambique Quirimbas Buffer GS", "Blue Carbon"),
    ("Madagascar Masoala Buffer GS", "REDD+"), ("Ethiopia Simien Mountains GS", "ARR"),
]
...
_BAD_NAMES_GS = [
    ...
    ("Phantom Wind Farm GS", "Renewable Energy"), ("Dubious Biochar GS Ltd", "Biochar"),
    ("Shadow REDD+ GS Ventures", "REDD+"), ("Ghost ARR GS Corp", "ARR"),
    ("Fake Blue Carbon GS Inc", "Blue Carbon"), ("Hollow Methane GS Solutions", "Methane Avoidance"),
    ("Phantom Cookstove GS II", "Cookstove"), ("Dubious Solar GS Holdings", "Renewable Energy"),
    ("Shadow Forest GS International", "REDD+"), ("Ghost Water Credits GS", "Other"),
    ("Fake Conservation GS Corp", "REDD+"), ("Hollow Energy GS Solutions", "Renewable Energy"),
    ("Phantom Mangrove GS Ventures", "Blue Carbon"),
]
...
def _make_project(idx, name, ptype, registry, quality_tier):
    ...
    return {
        "external_id": f"{prefix}-{1000 + idx * 17}",
        "name": name,
        "description": desc,
        "project_type": ptype,
...
def _generate_projects():
    """Gera 300 projetos: 150 Verra + 150 Gold Standard com distribuição de qualidade."""
    projects = []
    idx = 0

    # ─── 150 Projetos Verra ────────────────────────────────────────
    # 75 bons, 53 medianos, 22 ruins
    ...
    # ─── 150 Projetos Gold Standard ────────────────────────────────
    # 75 bons, 52 medianos, 23 ruins
...
# ─── Créditos: 2 por projeto (600 total) ──────────────────────────────
...
def _generate_credits():
    """Gera créditos para todos os 300 projetos."""
    credits = []
    for proj_idx, proj in enumerate(SEED_PROJECTS):
        ...
        credits.append({
            ...
            "quantity": qty2,
            "status": "active",
            "price_eur": round(price * random.uniform(0.9, 1.1), 2),
        })
